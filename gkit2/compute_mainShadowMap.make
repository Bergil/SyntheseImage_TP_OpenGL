...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/compute_mainShadowMap
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/compute_mainShadowMap
...
ifeq ($(config),release)
  OBJDIR     = obj/release/compute_mainShadowMap
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/compute_mainShadowMap
...
OBJECTS := \
	...
	$(OBJDIR)/nvSDLFont.o \
	$(OBJDIR)/compute_mainShadowMap.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking compute_mainShadowMap
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning compute_mainShadowMap
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/nvSDLFont.o: gKit/Widgets/nvSDLFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/compute_mainShadowMap.o: compute_mainShadowMap.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
