...
struct TVec3
{
    ...
    TVec3( const TVec2<T>& _v, const T _z = T(0) ) :  x( _v.x ), y( _v.y ), z( _z ) {}
...
struct TVec4
{
    ...
    TVec4( const TVec2<T>& _v, const T _z = T(0), const T _w= T(0) ) :  x( _v.x ), y( _v.y ), z( _z ), w( _w )  {}
    TVec4( const TVec3<T>& _v, const T _w= T(0) ) :  x( _v.x ), y( _v.y ), z( _v.z ), w( _w )  {}
