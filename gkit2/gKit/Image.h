...
protected:
    ...
    void setPixel( const unsigned int offset, const Vec4& color )
    {
        switch(type)
        {
            case UNSIGNED_BYTE: 
    ...
    Vec4 pixel( const unsigned int offset ) const
    {
        Vec4 color(0, 0, 0, 1);
        switch(type)
        {
...
public:
    ...
    //! modifie la valeur d'un pixel.
    void setPixel( const unsigned int x, const unsigned int y, const Vec4& color )
    {
        setPixel(offset(x,y), color);
    }
    
    //! modifie la valeur d'un pixel.
    void setPixel( const unsigned int x, const unsigned int y, const unsigned int z, const Vec4& color )
    {
        setPixel(offset(x, y, z), color);
    }
    
    //! renvoie la valeur d'un pixel.
    Vec4 pixel( const unsigned int x, const unsigned int y ) const
    {
        return pixel(offset(x, y));
    }
    
    //! renvoie la valeur d'un pixel.
    Vec4 pixel( const unsigned int x, const unsigned int y, const unsigned int z ) const
    {
...
Image *createImage( const int w, const int h, const Vec4& color, const int channels= 4, const unsigned int type= Image::FLOAT );
