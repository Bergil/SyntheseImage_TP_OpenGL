...
public:
    ...
    explicit Color( const Vec4& color ) : Vec4(color) {}
    
    Color( const float _r, const float _g, const float _b, const float _a= 1.f ) :  Vec4( _r, _g, _b, _a ) {}
    
    //! constructeur.
    Color( const float _v, const float _a= 1.f ) : Vec4( _v, _v, _v, _a ) {}
...
public:
    ...
    //! calcule l'intersection avec la BBox b.
    ...
    //! renvoie vrai si la BBox est vide / non valide.
    bool isEmpty( ) const
    {
...
//! renvoie l'intersection de 2 BBox.
