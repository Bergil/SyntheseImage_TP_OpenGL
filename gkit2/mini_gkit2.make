...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/mini_gkit2
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/mini_gkit2
...
$(OBJDIR)/nvSDLFont.o: gKit/Widgets/nvSDLFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/mini_gkit2.o: mini_gkit2.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
